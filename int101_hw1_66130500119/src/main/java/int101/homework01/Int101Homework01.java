...
public class Int101Homework01 {
    ...
    public static void main(String[] args) {
        ...
        work03UseOfUtilityClass(51,1.75,30,50,30);
    ...
    static void work04UseOfObjectClass() {
      ...
      */
        ...
        BankAccount a1 = new BankAccount(1, p1);
        BankAccount a2 = new BankAccount(2, p2);
        a1.deposit(5000);
        a1.withdraw(500);
        System.out.println("Owner account is " + a1.getOwner());
        System.out.println("balance = " + a1.getBalance());
        a2.deposit(9000);
        a2.withdraw(2000);
        System.out.println("Owner account is " + a2.getOwner() + " Balance = " + a2.getBalance()) ;
        a1.transfer(1000, a2);
        System.out.println(a1.toString() + " transfer to " + a2.toString());
